...
describe Capone::Application, 'basic functionality' do
  
  it 'should be a valid Rack application' do
    app {
      get('/'){ 'hello from Capone rack app!' }
    }.should respond_to(:call)
  end

  it 'should be able to test a simple Capone app' do
    app do
  ...
  it 'should be able to test *another* simple Capone app' do
    app do
